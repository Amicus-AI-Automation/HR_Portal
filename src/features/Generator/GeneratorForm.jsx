...
const GeneratorForm = ({ onJDGenerated }) => {
    ...
    const openai = new OpenAI({
        ...
        dangerouslyAllowBrowser: true, // Necessary for client-side prototype
        defaultHeaders: {
            "HTTP-Referer": window.location.origin, // Optional, for OpenRouter rankings
            "X-Title": "HR Dashboard", // Optional, for OpenRouter rankings
        }
    });
    ...
    const generateFullJD = async () => {
        ...
        try {
            const response = await openai.chat.completions.create({
                ...
                messages: [
                    { role: "system", content: "You are a professional HR assistant specializing in writing high-quality job descriptions." },
            ...
            const jdContent = response.choices[0].message.content;
            ...
            const errorMessage = err.message || "An unexpected error occurred with OpenRouter.";
